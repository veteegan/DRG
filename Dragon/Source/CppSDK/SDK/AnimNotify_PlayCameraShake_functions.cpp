...
#include "AnimNotify_PlayCameraShake_classes.hpp"
#include "AnimNotify_PlayCameraShake_parameters.hpp"
...
class FString UAnimNotify_PlayCameraShake_C::GetNotifyName()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotify_PlayCameraShake_C", "GetNotifyName");

	Params::AnimNotify_PlayCameraShake_C_GetNotifyName Parms{};
...
bool UAnimNotify_PlayCameraShake_C::Received_Notify(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AnimNotify_PlayCameraShake_C", "Received_Notify");

	Params::AnimNotify_PlayCameraShake_C_Received_Notify Parms{};
