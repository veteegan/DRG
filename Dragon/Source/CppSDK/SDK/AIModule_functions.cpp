...
void UBTFunctionLibrary::ForceNotifyBlackboardValue(class UBTNode* NodeOwner, const struct FBlackboardKeySelector& Key)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BTFunctionLibrary", "ForceNotifyBlackboardValue");

	Params::BTFunctionLibrary_ForceNotifyBlackboardValue Parms{};
...
class UBehaviorTreeComponent* UBTFunctionLibrary::GetBehaviorTree(class UBTNode* NodeOwner)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("BTFunctionLibrary", "GetBehaviorTree");

	Params::BTFunctionLibrary_GetBehaviorTree Parms{};
...
class UBTNode* UBehaviorTreeComponent::FindService(const class FString& Param_Name) const
{
	static class UFunction* Func = nullptr;
...
void AAIController::UpdateMoveFocus()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AIController", "UpdateMoveFocus");
...
// bool                                    bStopOnNoProgress                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UAITask_MoveTo* UAITask_MoveTo::AIMoveTo(class AAIController* Controller, const struct FVector& GoalLocation, class AActor* GoalActor, float AcceptanceRadius, EAIOptionFlag StopOnOverlap, EAIOptionFlag AcceptPartialPath, bool bUsePathfinding, bool bLockAILogic, bool bUseContinuosGoalTracking, bool bStopOnNoProgress)
{
	...
	Parms.bStopOnNoProgress = bStopOnNoProgress;
