...
public:
    template<class T>
    static inline T* Cast(UObject* src)
    {
...
public:
	...
	FNativeFuncPtr                                ExecFunction;                                      // 0x0040(0x0008)(NOT AUTO-GENERATED PROPERTY)
...
class UClass : public UStruct, private FClassBaseChain
{
public:
    ...
    EClassCastFlags     CastFlags;                                         // 0x00B8(0x0008)(NOT AUTO-GENERATED PROPERTY)
    ...
    uint8               Pad_110[0x168];                                    // 0x0110(0x0168)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
    ...
    class UObject* GetDefaultObject()
    {
        ...
        DefaultObject = reinterpret_cast<UObject*(*)(const UClass*)>(VTable[107])(this);
        return DefaultObject;
    }

    inline bool IsChildOf(const UClass* SomeBase) const
    {
        return FClassBaseChain::IsAUsingClassArray(*SomeBase);
    }
...
{
public:
	uint8                                         Pad_278[0x68];                                     // 0x0278(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
FORCEINLINE bool UObject::HasTypeFlag(EClassCastFlags TypeFlags) const
{
...
{
    return Class->IsChildOf(TypeClass);
}
...
FORCEINLINE bool UObject::IsDefaultObject() const
{
...
{
    if (FUObjectItem* Object = GObjects->GetItemByIndex(Index))
    {
