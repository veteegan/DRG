...
// Function Foliage.FoliageInstancedStaticMeshComponent.MulticastHideInstance
...
void UFoliageInstancedStaticMeshComponent::MulticastHideInstance(int32 OriginalIndex, const struct FVector& HitDirection)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FoliageInstancedStaticMeshComponent", "MulticastHideInstance");

	Params::FoliageInstancedStaticMeshComponent_MulticastHideInstance Parms{};
