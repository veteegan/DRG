...
struct FoliageInstancedStaticMeshComponent_MulticastHideInstance final
{
public:
	...
	struct FVector                                HitDirection;                                      // 0x0004(0x000C)(Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
