...
void UMediaPlaylist::RemoveAt(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
bool UMediaPlayer::GetMute()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "GetMute");

	Params::MediaPlayer_GetMute Parms{};
...
void UMediaPlayer::SetMute(bool bMute)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "SetMute");

	Params::MediaPlayer_SetMute Parms{};
